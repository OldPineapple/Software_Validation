...
class TestAddTodo(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        delete_response = requests.delete('http://localhost:4567/todos/' + todo_id)
    ...
    def test_add_1(self):
        ...
        todo_id = parsed['id']
        get_response = requests.get('http://localhost:4567/todos/' + str(todo_id))
        #print(get_response.text)
        get_parsed = json.loads(get_response.text)
        self.assertEqual(todo_id, get_parsed['todos'][0]['id'])
