...
class TestAddTodo(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        delete_response = requests.delete('http://localhost:4567/categories/' + category_id)
    ...
    def test_add_1(self):
        ...
        get_response = requests.get('http://localhost:4567/categories/' + str(category_id))
        #print(get_response.text)
        get_parsed = json.loads(get_response.text)
        self.assertEqual(category_id, get_parsed['categories'][0]['id'])
